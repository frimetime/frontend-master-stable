...
let SignupPage = SignupPage_1 = class SignupPage {
    // this.validations_form out of ngOninit()!!!!!!!!!!!!!!!!!!!!!!
    constructor(authService, db, // new
    formBuilder, router, platform, imagePicker, menuCtrl, loadingController, http, firebaseService, alertController) {
        ...
        this.validation_messages = {
            ...
            'country': [
                { type: 'required', message: 'Choose a country.' }
            ],
            'email': [
        ...
        this.validations_form = this.formBuilder.group({
            ...
            cbox: [false, SignupPage_1.mustBeTruthy]
        }, {
    ...
    tryRegister(value) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { userName, userEmail, birthdate, role, country, userPassword, cuserPassword } = this;
            ...
            this.authService.doRegister(value)
                ...
                if (res['code'] === 200) {
                    this.errorMessage = '';
                    this.successMessage = 'Account created successfully! Get started now!';
                    setTimeout(() => {
                        loading.dismiss();
                        this.router.navigate(['/auth/login']);
                    }, 5000);
...
SignupPage = SignupPage_1 = tslib_1.__decorate([
    Component({
        selector: 'app-signup',
